...
model = dict(
    ...
    template="[x]",
    clip_model="ViT-B/16",
    class_name=("wall", "floor", "cabinet", "bed", "chair", "sofa", "table", "door", "window",
                "bookshelf", "bookcase", "picture", "counter", "desk", "shelves", "curtain", "dresser",
                "pillow", "mirror", "ceiling", "refrigerator", "television", "shower curtain",
                "nightstand", "toilet", "sink", "lamp", "bathtub", "garbagebin", "board", "beam",
                "column", "clutter", "otherstructure", "otherfurniture", "otherprop"),
    valid_index=((0, 1, 2, 3, 4, 5, 6, 7, 8, 11, 13, 14, 15,
                  16, 17, 18, 19, 20, 21, 23, 25, 26, 33, 34, 35),
        ...
        datasets=[
            ...
            dict(
                ...
                transform=[
                    ...
                    dict(type="ToTensor"),
                    dict(type="Collect", keys=("coord", "discrete_coord", "segment", "condition"),
    ...
    test=dict(
        ...
        test_cfg=dict(
            ...
            post_transform=[
                ...
                dict(type="ToTensor"),
                dict(type="Collect",
                     keys=("coord", "discrete_coord", "index", "condition"),
                     feat_keys=("color", "normal"))
            ],
            aug_transform=[
